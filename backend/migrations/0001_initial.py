# Generated by Django 3.2.9 on 2022-05-27 07:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_productive', models.IntegerField(blank=True, default=0, null=True)),
                ('treated_pipes', models.IntegerField(blank=True, db_column='treated_pipes', default=0, null=True)),
                ('treated_good_pipes', models.IntegerField(blank=True, default=0, null=True)),
                ('treated_bad_pipes', models.IntegerField(blank=True, default=0, null=True)),
